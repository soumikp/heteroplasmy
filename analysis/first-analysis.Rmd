...
knitr::include_graphics("/Users/soumikp/Google Drive - Umich/mtDNA/heteroplasmy/docs/figure/first-analysis.Rmd")
```


```{r chunk1, echo = FALSE, eval = FALSE}
...
```{r chunk2, echo = FALSE, eval = FALSE}
prop <- function(x){
  return(x/sum(x))
}
...
The cluster is now running a Shiny app which gives us the above figure for each position, for all the individuals in the dataset. [Click here for more](http://shiny.sph.umich.edu/soumikp)
